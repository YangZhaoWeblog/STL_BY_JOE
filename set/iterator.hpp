...
class const_rb_tree_iterator
{
	...
	public:
		node_pointer get_ptr(){ return ptr;	}
		const_reference operator*( )const{ return this->ptr->date;	}
		bool operator==(const const_rb_tree_iterator& x)const{ return ptr == x.ptr;	}
		bool operator!=(const const_rb_tree_iterator& x)const{ return ptr != x.ptr;	}
		node_pointer operator->()const{ return &(operator*());	}
...
class const_reverse_rb_tree_iterator
{
	...
	public:
		node_pointer get_ptr(){ return ptr;	}
		const_reference operator*( )const{ return this->ptr->date;	}
		bool operator==(const const_reverse_rb_tree_iterator& x)const{ return ptr == x.ptr;	}
		bool operator!=(const const_reverse_rb_tree_iterator& x)const{ return ptr != x.ptr;	}
		node_pointer operator->()const{ return &(operator*());	}
